...
export const scenario: Scenario = {
  ...
  description:
    ...
    'positive, the U5 hand-off) -> sets logged (one with a range RPE "9-10") -> a mid-training "when last did I ' +
    'bench" (F5/BUG-030) -> finish -> a history question, over a hand-written upper/lower history ending in a ' +
    "completed-but-empty session (BUG-031); the persona writes Russian on an 'en' account (F3). " +
