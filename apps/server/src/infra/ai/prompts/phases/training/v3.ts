...
export interface TrainingPromptContextV3 extends DirectiveContext {}
...
export const TRAINING_V3: PromptModule<TrainingPromptContextV3> = {
  id: 'phase.training',
  version: 'v3',
  directives: DIRECTIVES_WITHOUT_IDENTITY_V1,
  render(ctx: TrainingPromptContextV3): Section[] {
    return [
      {
        id: 'intro',
        required: true,
