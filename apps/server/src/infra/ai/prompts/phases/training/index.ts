...
export { TRAINING_V1, TRAINING_V2, TRAINING_V3, TRAINING_V4, TRAINING_V5, TRAINING_V6, TRAINING_V7 };
 ...
 */
export const TRAINING_PROMPT: PhasePromptEntry<TrainingPromptContextV7> = {
  current: TRAINING_V7,
