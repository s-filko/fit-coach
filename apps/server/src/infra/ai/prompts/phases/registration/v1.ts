...
/** Moved verbatim from graph/nodes/registration.node.ts (P2, AC-1321 — snapshot-arbitered). */
export const REGISTRATION_V1: PromptModule<RegistrationPromptContext> = {
  id: 'phase.registration',
  version: 'v1',
  directives: DEFAULT_DIRECTIVES_V1,
  render(ctx: RegistrationPromptContext): Section[] {
    const { user } = ctx;
