...
const exerciseSeeds: ExerciseSeed[] = [
  ...
  {
    id: '6a15bb4e-5263-426b-a145-4285fbc15e8a',
    name: 'Lever Lat Pulldown (Plate-Loaded)',
    category: 'compound',
    equipment: 'machine',
    exerciseType: 'strength',
    description: 'Plate-loaded lever pulldown machine — vertical pull for lat width, load is plates per side',
    energyCost: 'medium',
    complexity: 'beginner',
    typicalDurationMinutes: 8,
    requiresSpotter: false,
  ...
  {
    id: 'c99be505-3501-4936-bc1a-8621e1b18570',
    name: 'Cable Tricep Pushdown, Rope',
    category: 'isolation',
    equipment: 'cable',
    exerciseType: 'strength',
    description:
      'Standing cable tricep pushdown with a two-ended rope — ends are pulled apart at the bottom for full triceps contraction',
    energyCost: 'low',
    complexity: 'beginner',
    typicalDurationMinutes: 6,
    requiresSpotter: false,
  ...
  {
    id: '266c672e-5bdf-4796-94f3-ad2c5abb21bc',
    name: '45° Leg Press',
    category: 'compound',
    equipment: 'machine',
    exerciseType: 'strength',
    description: 'Leg press with the sled on a 45° incline — lie back and press the platform up along the rails',
    energyCost: 'high',
    complexity: 'intermediate',
    typicalDurationMinutes: 10,
    requiresSpotter: false,
  ...
  {
    id: 'e3c9eacb-c11f-47ad-a525-e3d4a9373872',
    name: 'Glute Bridge',
    category: 'compound',
    equipment: 'bodyweight',
    exerciseType: 'strength',
    description: 'Bodyweight bridge lying on the back — glute and hamstring activation, gentle on the lower back',
    energyCost: 'low',
    complexity: 'beginner',
  ...
  {
    id: '3ef0ef05-24c9-43e8-8e09-baaae16b12f0',
    name: 'Side Plank',
    category: 'functional',
    equipment: 'bodyweight',
    exerciseType: 'isometric',
    description: 'Lateral core stability hold on one forearm — obliques and hip stabilisers, done per side',
    energyCost: 'low',
    complexity: 'beginner',
    typicalDurationMinutes: 5,
    requiresSpotter: false,
